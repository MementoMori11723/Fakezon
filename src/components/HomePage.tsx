  ...
  return (
    <div className='bg-fakezon-background'>
      <div className='min-w-[1000px] max-w-[1500px] m-auto'>
        <Carousel/><div className='grid grid-cols-3 xl:grid-cols-4 -mt-80'>
            ...
            <div className='m-3 pt-8'><img src={"../images/banner_image_2.jpg"} alt="" className='xl:hidden'/></div>
        </div>
        <CarouselProduct /><CarouselCategory/><div className='h-[200px]'><img className='h-[100%] m-auto' src={"./images/banner_image.jpg"}/></div>
      </div>
    </div>
  )
}
